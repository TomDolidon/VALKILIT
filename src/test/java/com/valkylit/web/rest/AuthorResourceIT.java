...
import static com.valkylit.domain.AuthorAsserts.*;
...
import com.valkylit.repository.AuthorRepository;
...
class AuthorResourceIT {
    ...
    public static Author createEntity() {
        return new Author().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Author createUpdatedEntity() {
        return new Author().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void putWithIdMismatchAuthor() throws Exception {
        ...
        restAuthorMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(author))
            )
            .andExpect(status().isBadRequest());
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
