...
import static com.valkylit.domain.BookCategoryAsserts.*;
...
class BookCategoryResourceIT {
    ...
    void getAllBookCategories() throws Exception {
        ...
        restBookCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(bookCategory.getId().toString())))
    ...
    void getBookCategory() throws Exception {
        ...
        restBookCategoryMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(bookCategory.getId().toString()))
    ...
    void getNonExistingBookCategory() throws Exception {
        // Get the bookCategory
        restBookCategoryMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void deleteBookCategory() throws Exception {
        ...
        restBookCategoryMockMvc
            .perform(delete(ENTITY_API_URL_ID, bookCategory.getId().toString()).accept(MediaType.APPLICATION_JSON))
