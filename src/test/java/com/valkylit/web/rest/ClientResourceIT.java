...
import static com.valkylit.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    public static Client createEntity() {
        return new Client().birthdate(DEFAULT_BIRTHDATE);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client().birthdate(UPDATED_BIRTHDATE);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.birthdate(UPDATED_BIRTHDATE);
    ...
    void putWithIdMismatchClient() throws Exception {
        ...
        restClientMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(client))
            )
            .andExpect(status().isBadRequest());
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.birthdate(UPDATED_BIRTHDATE);
