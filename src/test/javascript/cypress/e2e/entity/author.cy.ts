...
describe('Author e2e test', () => {
  ...
  const authorSample = { name: 'mélancolique au lieu de de peur de' };
  ...
  describe('new Author page', () => {
    ...
    it('should create an instance of Author', () => {
      cy.get(`[data-cy="name"]`).type('ouch plouf biathlète');
      cy.get(`[data-cy="name"]`).should('have.value', 'ouch plouf biathlète');
