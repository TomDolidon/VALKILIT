...
describe('Publisher e2e test', () => {
  ...
  const publisherSample = { name: 'sans que de la part de' };
  ...
  describe('new Publisher page', () => {
    ...
    it('should create an instance of Publisher', () => {
      cy.get(`[data-cy="name"]`).type('population du Québec');
      cy.get(`[data-cy="name"]`).should('have.value', 'population du Québec');
