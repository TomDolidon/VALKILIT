...
public class SecurityConfiguration {
    ...
    private final String headers =
        "default-src 'self' https: http:; frame-src 'self' https: http: data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https: http: https://storage.googleapis.com; style-src 'self' 'unsafe-inline' https: http:; img-src 'self' https: http: data:; font-src 'self' https: http: data: ";
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http
            ...
            .headers(headers ->
                headers
                    .contentSecurityPolicy(csp -> csp.policyDirectives(this.headers))
