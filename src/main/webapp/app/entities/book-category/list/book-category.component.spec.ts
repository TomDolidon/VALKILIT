...
import { sampleWithRequiredData } from '../book-category.test-samples';
...
describe('BookCategory Management Component', () => {
  let comp: BookCategoryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(BookCategoryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bookCategories?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to bookCategoryService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getBookCategoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBookCategoryIdentifier).toHaveBeenCalledWith(entity);
