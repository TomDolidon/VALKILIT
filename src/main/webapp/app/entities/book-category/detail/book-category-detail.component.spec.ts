...
describe('BookCategory Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { bookCategory: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load bookCategory on init', async () => {
      ...
      // THEN
      expect(instance.bookCategory()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
