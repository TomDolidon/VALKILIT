...
describe('Address Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { address: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load address on init', async () => {
      ...
      // THEN
      expect(instance.address()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
