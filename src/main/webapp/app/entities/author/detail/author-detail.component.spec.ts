...
describe('Author Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { author: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load author on init', async () => {
      ...
      // THEN
      expect(instance.author()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
