...
import { sampleWithRequiredData } from '../award.test-samples';
import { AwardService } from '../service/award.service';

import { AwardComponent } from './award.component';
import SpyInstance = jest.SpyInstance;

describe('Award Management Component', () => {
  let comp: AwardComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AwardComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.awards?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to awardService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getAwardIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAwardIdentifier).toHaveBeenCalledWith(entity);
