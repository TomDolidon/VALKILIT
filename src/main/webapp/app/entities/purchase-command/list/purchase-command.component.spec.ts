...
import { sampleWithRequiredData } from '../purchase-command.test-samples';
...
describe('PurchaseCommand Management Component', () => {
  let comp: PurchaseCommandComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [PurchaseCommandComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(PurchaseCommandComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.purchaseCommands?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to purchaseCommandService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getPurchaseCommandIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPurchaseCommandIdentifier).toHaveBeenCalledWith(entity);
