...
describe('Publisher Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { publisher: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load publisher on init', async () => {
      ...
      // THEN
      expect(instance.publisher()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
