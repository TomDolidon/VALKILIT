...
describe('Client Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      const client: IClient = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const internalUser: IUser = { id: 17149 };
      client.internalUser = internalUser;

      const userCollection: IUser[] = [{ id: 15220 }];
    ...
    it('Should call Address query and add missing value', () => {
      const client: IClient = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const address: IAddress = { id: 'bfced034-6e6c-465a-9f43-d0b72a98ab5b' };
      client.address = address;

      const addressCollection: IAddress[] = [{ id: '0c8f87fc-daef-4a57-9575-b41acf4e6c61' }];
    ...
    it('Should update editForm', () => {
      const client: IClient = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const internalUser: IUser = { id: 30398 };
      client.internalUser = internalUser;
      const address: IAddress = { id: '26f9cc12-f250-4eb1-bfb0-fb56d3d80be2' };
      client.address = address;
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      ...
      const client = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
