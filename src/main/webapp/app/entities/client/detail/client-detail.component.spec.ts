...
describe('Client Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { client: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load client on init', async () => {
      ...
      // THEN
      expect(instance.client()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
