...
describe('Review Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Client query and add missing value', () => {
      ...
      const client: IClient = { id: '76013934-4325-4727-9b1c-9279dcc35fdf' };
      review.client = client;

      const clientCollection: IClient[] = [{ id: '24e01fb5-4e32-4da2-8888-6d1bf6356b26' }];
    ...
    it('Should call Book query and add missing value', () => {
      const review: IReview = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const book: IBook = { id: 'bfca6c5d-919e-4b47-ba82-f60a24edb344' };
      review.book = book;

      const bookCollection: IBook[] = [{ id: 'f0ac0c8e-bed7-43fa-9081-4914441d42e9' }];
    ...
    it('Should update editForm', () => {
      const review: IReview = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const client: IClient = { id: '8210e09c-d3d6-4483-b875-fbc52b2c9fd2' };
      review.client = client;
      const book: IBook = { id: '187ae7b4-716e-415d-b4ab-02f6b1565e02' };
      review.book = book;
