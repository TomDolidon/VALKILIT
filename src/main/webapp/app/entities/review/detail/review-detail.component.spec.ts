...
describe('Review Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { review: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load review on init', async () => {
      ...
      // THEN
      expect(instance.review()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
